...
public class newMember extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Добавить участника");
        ...
        jLabel11.setText("Тип членства");

        jLabel12.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel12.setText("Дата регистрации");

        fnEmpty.setForeground(new java.awt.Color(255, 0, 0));
        fnEmpty.setText("обязательно для ввода");

        lnEmpty.setForeground(new java.awt.Color(255, 0, 0));
        lnEmpty.setText("обязательно для ввода");

        addressEmpty.setForeground(new java.awt.Color(255, 0, 0));
        addressEmpty.setText("обязательно для ввода");

        phoneNumsEmpty.setForeground(new java.awt.Color(255, 0, 0));
        phoneNumsEmpty.setText("обязательно для ввода");
