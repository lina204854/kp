...
public class payment extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Имя", "Тип членства", "Сумма", "Дата платежа", "Действительно до", "Осталось", "Статус"
            }
        ) {
        ...
        jLabel2.setText("Введите действительный ID для получения информации");

        jLabel3.setText("ID члена");
