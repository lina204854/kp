...
public class trainer extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel10.setText("Моб. телефон");

        jLabel9.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel9.setText("Дата присоединения");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Имя", "Возраст", "Адрес", "Дата присоединения", "Моб. телефон"
            }
        ) {
        ...
        resetBtn.setText("Перезапустить");
        ...
        jLabel4.setText("Введите действительный ID, чтобы получить необходимую информацию");

        jLabel5.setText("ID Тренера:");
